...
#数据路径
train_data_path = '/data/Newdisk/chenjingwen/DT_B4/GD_detect/image/selected_2/warship/VGG16/PatchAttack_mindspore'
val_data_path = '/data/Newdisk/chenjingwen/DT_B4/GD_detect/image/selected_2/warship/VGG16/PatchAttack_mindspore'
