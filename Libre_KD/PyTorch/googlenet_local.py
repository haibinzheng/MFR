...
if __name__ == "__main__":
    FGSM_IMAGES_PATH = "/data/Newdisk/chenjingwen/DT_B4/GD_detect/image/selected_2/military/GoogleNet/OnePixel"  # 测试数据集路径

    DETECTOR_PATH = '/data/Newdisk/chenjingwen/DT_B4/GD_detect/image/kd_save/save_rf/GoogleNet_military_ALL_CNN_Classifier_0.9989130434782608.pth'
