...
trained_model_name = 'S2_transfer_VGGNet_10Class_77Acc_3Epoch.pth' # 用于迁移学习的模型

transfer_train_data = 'train_transfer70_80class'
transfer_test_data = 'test_transfer70_80class'
...
#            outputs,aux2,aux1 = model(inputs)
   ...
   if now_acc>acc1:
       ...
       torch.save(model.state_dict(), './VGGNet_models/S3_transfer_VGGNet_%dClass_%dAcc_%dEpoch.pth'%(num_classes, acc1,epoch))