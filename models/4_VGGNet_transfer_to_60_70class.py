...
trained_model_name = 'S3_transfer_VGGNet_10Class_66Acc_2Epoch.pth' # 用于迁移学习的模型

transfer_train_data = 'train_transfer60_70class' # 选择迁移的训练数据集
transfer_test_data = 'test_transfer60_70class'
...
#            outputs,aux2,aux1 = model(inputs)
   ...
   if now_acc>acc1:
       ...
       torch.save(model.state_dict(), './VGGNet_models/S4_transfer_VGGNet_%dClass_%dAcc_%dEpoch.pth'%(num_classes, acc1,epoch))