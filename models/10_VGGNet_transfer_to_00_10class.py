...
num_classes = 10
epochs = 10
trained_model_name = 'S9_transfer_VGGNet_10Class_80Acc_4Epoch.pth' # 用于迁移学习的模型

transfer_train_data = 'train_transfer00_10class' # 选择迁移的训练数据集
...
#            outputs,aux2,aux1 = model(inputs)
   ...
   if now_acc>acc1:
       ...
       torch.save(model.state_dict(), './VGGNet_models/S10_transfer_VGGNet_%dClass_%dAcc_%dEpoch.pth'%(num_classes, acc1,epoch))