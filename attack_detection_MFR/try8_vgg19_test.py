...
def main(slef):
        ...
        for idx, image in enumerate(x_test0):
            if idx>-1:
                ...
                if adversarial is None:
                    ...
                    np.save('/home/Bear/attack_detection/cw_vgg19_cifar10/orin1/y_adtest/{}'.format(image_name),adv_label)
                    np.save('/home/Bear/attack_detection/cw_vgg19_cifar10/orin1/x_adtest/{}'.format(image_name), adversarial)
                    np.save('/home/Bear/attack_detection/cw_vgg19_cifar10/orin1/y_adconfidence/{}'.format(image_name), adconfidence)
                    np.save('/home/Bear/attack_detection/cw_vgg19_cifar10/orin1/x_test/{}'.format(image_name), image)
                    np.save('/home/Bear/attack_detection/cw_vgg19_cifar10/orin1/y_test/{}'.format(image_name), np.argmax(y_test0[idx]))
                    np.save('/home/Bear/attack_detection/cw_vgg19_cifar10/orin1/y_pred/{}'.format(image_name), pred_label)
                    np.save('/home/Bear/attack_detection/cw_vgg19_cifar10/orin1/y_confidence/{}'.format(image_name), confidence)
                    np.save('/home/Bear/attack_detection/cw_vgg19_cifar10/orin1/cl/{}'.format(image_name), idx)
    ...
    #
    # np.save('/home/Bear/attack_detection/cw_vgg19_cifar10/orin/x_test',x_testl)
    # np.save('/home/Bear/attack_detection/cw_vgg19_cifar10/orin/y_test', y_testl)
    ...
    # np.save('/home/Bear/attack_detection/cw_vgg19_cifar10/orin/cl',cl)
