...
x_test=np.load('/home/Bear/attack_detection/CRA_resnet_cifar10/cifar10_all/x_test00.npy')
x_adtest=np.load('/home/Bear/attack_detection/CRA_resnet_cifar10/cifar10_all/x_adtest00.npy')
print(x_test.shape)
...
for j in ['s1','s2','x1','x2','z1','z2','y1','y2']:
    if j=='s1':
        ...
        # np.save('/home/Bear/attack_detection/CRA_resnet_cifar10/cifar10_all/x_tests1', x_test_ts1)
        ...
        # np.save('/home/Bear/attack_detection/CRA_resnet_cifar10/cifar10_all/x_adtests1', x_adtest_ts1)
