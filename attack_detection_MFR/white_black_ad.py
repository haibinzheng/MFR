...
x_black1=np.load('/home/Bear/attack_detection/GBA_vgg16_cifar10/cifar10_all/56/x_confidence56.npy')
x_black2=np.load('/home/Bear/attack_detection/LSA_vgg16_cifar10/cifar10_all/56/x_confidence56.npy')
x_black3=np.load('/home/Bear/attack_detection/PWA_vgg16_cifar10/cifar10_all/56/x_confidence56.npy')
x_black4=np.load('/home/Bear/attack_detection/CRA_vgg16_cifar10/cifar10_all/56/x_confidence56.npy')
...
x_white1=np.load('/home/Bear/attack_detection/cw_vgg16_cifar10/cifar10_all/56/x_confidence56.npy')
x_white2=np.load('/home/Bear/attack_detection/deepfool_vgg16_cifar10/cifar10_all/56/x_confidence56.npy')
x_white3=np.load('/home/Bear/attack_detection/fgsm_vgg16_cifar10/cifar10_all/56/x_confidence56.npy')
...
np.save('/home/Bear/attack_detection/WorB/X56_co',X)
np.save('/home/Bear/attack_detection/WorB/Y56_co',Y)
print(X.shape)
print(Y.shape)
