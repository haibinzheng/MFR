...
def main(self):
    ...
    save_dir = os.path.join(os.getcwd(), '/home/Bear/attack_detection/1_resnet_saved_models')
        ...
        for idx, image in enumerate(x_test):
            if idx>8670:
                ...
                if adversarial is None:
                    ...
                    y_testl.append(np.argmax(y_test[idx]))
                    ...
                    print("name:{},reallabel:{},source label:{},adv label:{} ".format(image_name,np.argmax(y_test[idx]),
                                                                                      pred_label,adv_label))

                    # np.save('/home/Bear/attack_detection/boundary_resnet_cifar10/orin/y_adtest/{}'.format(image_name), adv_label)
                    # np.save('/home/Bear/attack_detection/boundary_resnet_cifar10/orin/x_adtest/{}'.format(image_name), adversarial)
                    # np.save('/home/Bear/attack_detection/boundary_resnet_cifar10/orin/y_adconfidence/{}'.format(image_name),adconfidence)
                    # np.save('/home/Bear/attack_detection/boundary_resnet_cifar10/orin/x_test/{}'.format(image_name), image)
                    # np.save('/home/Bear/attack_detection/boundary_resnet_cifar10/orin/y_test/{}'.format(image_name), np.argmax(y_test0[idx]))
                    # np.save('/home/Bear/attack_detection/boundary_resnet_cifar10/orin/y_pred/{}'.format(image_name), pred_label)
                    # np.save('/home/Bear/attack_detection/boundary_resnet_cifar10/orin/y_confidence/{}'.format(image_name),confidence)
                    # np.save('/home/Bear/attack_detection/boundary_resnet_cifar10/orin/cl/{}'.format(image_name), idx)
    ...
    np.save('/home/Bear/attack_detection/boundary_resnet_cifar10/orin/x_test',x_testl)
    np.save('/home/Bear/attack_detection/boundary_resnet_cifar10/orin/y_test', y_testl)
    np.save('/home/Bear/attack_detection/boundary_resnet_cifar10/orin/x_adtest',x_adtest)
    np.save('/home/Bear/attack_detection/boundary_resnet_cifar10/orin/y_adtest', y_adtest)
    np.save('/home/Bear/attack_detection/boundary_resnet_cifar10/orin/y_pred', y_pred)
    np.save('/home/Bear/attack_detection/boundary_resnet_cifar10/orin/y_confidence', y_confidence)
    np.save('/home/Bear/attack_detection/boundary_resnet_cifar10/orin/y_adconfidence', y_adconfidence)
    np.save('/home/Bear/attack_detection/boundary_resnet_cifar10/orin/cl',cl)
