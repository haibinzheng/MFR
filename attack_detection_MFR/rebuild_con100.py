...
parser.add_argument('-am', '--attack_method', default=foolbox.attacks.CarliniWagnerL2Attack(confidence=100))  # 选择攻击方式，比如FGSM
...
def main(slef):
    ...
    model.load_weights('/home/zhb/Documents/Python/LLY/attack_detection/1_cnn_saved_models/keras_cifar10_trained_model.h5')  # 模型文件路径

    # Convert class vectors to binary class matrices.
    x_test0=np.load('/home/zhb/Documents/Python/LLY/attack_detection/cifar10_test/x_test10000.npy')
    y_test0=np.load('/home/zhb/Documents/Python/LLY/attack_detection/cifar10_test/y_test10000.npy')
    print(x_test0.shape)
    print(y_test0.shape)
    ...
    np.save('/home/zhb/Documents/Python/LLY/attack_detection/cw2_cifar10/orin/x_test',x_testl)
    np.save('/home/zhb/Documents/Python/LLY/attack_detection/cw2_cifar10/orin/y_test', y_testl)
    np.save('/home/zhb/Documents/Python/LLY/attack_detection/cw2_cifar10/orin/x_adtest',x_adtest)
    np.save('/home/zhb/Documents/Python/LLY/attack_detection/cw2_cifar10/orin/y_adtest', y_adtest)
    np.save('/home/zhb/Documents/Python/LLY/attack_detection/cw2_cifar10/orin/y_pred', y_pred)
    np.save('/home/zhb/Documents/Python/LLY/attack_detection/cw2_cifar10/orin/y_confidence', y_confidence)
    np.save('/home/zhb/Documents/Python/LLY/attack_detection/cw2_cifar10/orin/y_adconfidence', y_adconfidence)
