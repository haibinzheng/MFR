...
parser.add_argument('-am', '--attack_method', default=foolbox.attacks.ContrastReductionAttack)  # 选择攻击方式，比如FGSM
...
print('foolbox.attacks.CRA_resnet_cifar10')
# 打开ROOT_DIR的完整路径
...
def main(self):
    ...
    np.save('/home/Bear/attack_detection/CRA_resnet_cifar10/orin/x_test',x_testl)
    np.save('/home/Bear/attack_detection/CRA_resnet_cifar10/orin/y_test', y_testl)
    np.save('/home/Bear/attack_detection/CRA_resnet_cifar10/orin/x_adtest',x_adtest)
    np.save('/home/Bear/attack_detection/CRA_resnet_cifar10/orin/y_adtest', y_adtest)
    np.save('/home/Bear/attack_detection/CRA_resnet_cifar10/orin/y_pred', y_pred)
    np.save('/home/Bear/attack_detection/CRA_resnet_cifar10/orin/y_confidence', y_confidence)
    np.save('/home/Bear/attack_detection/CRA_resnet_cifar10/orin/y_adconfidence', y_adconfidence)
    np.save('/home/Bear/attack_detection/CRA_resnet_cifar10/orin/cl',cl)
