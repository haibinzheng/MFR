...
def main(slef):
    ...
    np.save('/home/Bear/attack_detection/cw2_cifar10/orin/x_test0',x_testl)
    np.save('/home/Bear/attack_detection/cw2_cifar10/orin/y_test0', y_testl)
    np.save('/home/Bear/attack_detection/cw2_cifar10/orin/x_adtest0',x_adtest)
    np.save('/home/Bear/attack_detection/cw2_cifar10/orin/y_adtest0', y_adtest)
    np.save('/home/Bear/attack_detection/cw2_cifar10/orin/y_pred0', y_pred)
    np.save('/home/Bear/attack_detection/cw2_cifar10/orin/y_confidence0', y_confidence)
    np.save('/home/Bear/attack_detection/cw2_cifar10/orin/y_adconfidence0', y_adconfidence)
