...
def main(slef):
    ...
    np.save('/home/Bear/attack_detection/deepfool_cnn_cifar10/orin/x_test',x_testl)
    np.save('/home/Bear/attack_detection/deepfool_cnn_cifar10/orin/y_test', y_testl)
    np.save('/home/Bear/attack_detection/deepfool_cnn_cifar10/orin/x_adtest',x_adtest)
    np.save('/home/Bear/attack_detection/deepfool_cnn_cifar10/orin/y_adtest', y_adtest)
    np.save('/home/Bear/attack_detection/deepfool_cnn_cifar10/orin/y_pred', y_pred)
    np.save('/home/Bear/attack_detection/deepfool_cnn_cifar10/orin/y_confidence', y_confidence)
    np.save('/home/Bear/attack_detection/deepfool_cnn_cifar10/orin/y_adconfidence', y_adconfidence)
