...
if __name__ == "__main__":
    FGSM_IMAGES_PATH = "/data/Newdisk/chenjingwen/DT_B4/SJS_detect/object_detection/datasets/FILR_adv_true_mwb/select/FGSM_r"  # 测试数据集路径

    DETECTOR_PATH = '/data/Newdisk/chenjingwen/DT_B4/SJS_detect/object_detection/frcnn_detect/model_data/ALL_v2_FLIR_CNN_Classifier_0.86.pth'
            ...
            if file.lower().endswith(supported_extensions):
                ...
                with open(file_path, "rb") as img_file:
                    ...
                    if 'ori' in file_path.split('/') and result ==1:
                        shutil.copy(file_path,  os.path.join('/data/Newdisk/chenjingwen/DT_B4/SJS_detect/object_detection/datasets/FILR_adv_true_mwb/select/FGSM/ori', os.path.basename(file)))
                    ...
                    if 'adv' in file_path.split('/') and result == 0:
                        shutil.copy(file_path,  os.path.join('/data/Newdisk/chenjingwen/DT_B4/SJS_detect/object_detection/datasets/FILR_adv_true_mwb/select/FGSM/adv', os.path.basename(file)))
