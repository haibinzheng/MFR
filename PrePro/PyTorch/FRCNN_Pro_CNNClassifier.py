...
def train_binary_classifier(params):
    ...
    for i in range(num):
        ...
        crop_and_save_image(train_path[num + i], box1,
                            os.path.join(image_SaveDir + "/{}/train/ori".format(All_Attack_Methods[0]),
                                         os.path.basename(train_path[num + i])))
        crop_and_save_image(train_path[i], box2,
                            os.path.join(image_SaveDir + "/{}/train/adv".format(All_Attack_Methods[0]),
    ...
    for i in range(num111):
        ...
        crop_and_save_image(test_path[num111 + i], box1,
                            os.path.join(image_SaveDir + "/{}/test/ori".format(All_Attack_Methods[0]),
                                         os.path.basename(test_path[num111 + i])))
        crop_and_save_image(test_path[i], box2,
                            os.path.join(image_SaveDir + "/{}/test/adv".format(All_Attack_Methods[0]),
    ...
    path111 = image_SaveDir + "/{}/train".format(All_Attack_Methods[0])
    path222 = image_SaveDir + "/{}/test".format(All_Attack_Methods[0])
