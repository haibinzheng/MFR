...
def train_binary_classifier(params):
    ...
    dataset = datasets.ImageFolder(
        root='/data/Newdisk/chenjingwen/DT_B4/SJS_detect/object_detection/datasets/YOLOX_warship_adv/all_attack/ALL_warship/train',
        transform=transform)
    ...
    for epoch in range(train_epochs):
        ...
        if Test_Accuarcy > Best_Acc and Test_Accuarcy > 0.50:
            ...
            torch.save(model.state_dict(),
                       '/data/Newdisk/chenjingwen/DT_B4/GD_detect/object_detection/Yolo_detect/save_model/ALL_warship_CNN_Classifier_{}.pth'.format(
                           Test_Accuarcy))
            saved_path = '/data/Newdisk/chenjingwen/DT_B4/GD_detect/object_detection/Yolo_detect/save_model/ALL_warship_CNN_Classifier_{}.pth'.format(
                Test_Accuarcy)
...
def CNN_Classifier_Detect(params):
    ...
    all_attack_methods = ['patch_attack','GuassianBlurAttack','FGSM','MIFGSM']
    detect_result = []
    # transforms.Normalize(mean=[0.485, 0.456, 0.406], std=[0.229, 0.224, 0.225]),
    for attack_method in all_attack_methods:
        output_dir = f'/data/Newdisk/chenjingwen/DT_B4/GD_detect/object_detection/Yolo_detect/select_coco/{attack_method}'
        # Initialize the dataset
        dataset = datasets.ImageFolder(
            root='/data/Newdisk/chenjingwen/DT_B4/GD_detect/object_detection/Yolo_detect/select_warship/{}'.format(
        ...
        model = CNN().to(device)
        model_path = '/data/Newdisk/chenjingwen/DT_B4/GD_detect/object_detection/Yolo_detect/save_model/ALL_v2_warship_CNN_Classifier_0.9366666666666666.pth'
        ...
        path333 = '/data/Newdisk/chenjingwen/DT_B4/GD_detect/object_detection/Yolo_detect/select_warship/{}'.format(
                attack_method)
