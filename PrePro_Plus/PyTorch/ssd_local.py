...
if __name__ == "__main__":
    FGSM_IMAGES_PATH = "/data/Newdisk/chenjingwen/DT_B4/IndicatorsCoverage/SJS/PrePro_Plus/SSD/dataset/VOC/backdoor_less"  # 测试数据集路径

    DETECTOR_PATH = '/data/Newdisk/chenjingwen/DT_B4/SJS_detect/object_detection/ssd_detect/model_data/backdoor_CNN_classifier_0.10747957259585167.pth'
        ...
        for file in files:
            if file.lower().endswith(supported_extensions):
                ...
                with open(file_path, "rb") as img_file:
                    ...
                    #         '/data/Newdisk/chenjingwen/DT_B4/IndicatorsCoverage/SJS/PrePro_Plus/SSD/dataset/VOC/backdoor_less/ori',
                    #         os.path.basename(file)))
                    #
                    # if 'poi' in file_path.split('/') and result == 0 and adv_saved<50:
                    #     adv_saved += 1
                    #     shutil.copy(file_path, os.path.join(
                    #         '/data/Newdisk/chenjingwen/DT_B4/IndicatorsCoverage/SJS/PrePro_Plus/SSD/dataset/VOC/backdoor_less/poi',
                    #         os.path.basename(file)))
