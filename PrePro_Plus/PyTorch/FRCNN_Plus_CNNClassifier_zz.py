...
import torchvision.models as models
from frcnn_plus_zz import FRCNN
...
def train_binary_classifier(params):
    ...
    for i in range(len(All_Attack_Methods)):
        ...
        if All_Attack_Methods[i] == 'backdoor':
            ...
            adv_path = '/data/Newdisk/chenjingwen/DT_B4/SJS_detect/object_detection/datasets/warship_frcnn/FGSM_result'
