...
def vgg_patchattack_detection(image, model):
    # print("local......................")
    # print(image)
    img = Image.open(image)
    detection_model = model[0]
...
def vgg_deepfool_detection(image, model):
    # print("local......................")
    # print(image)
    img = Image.open(image)
    detection_model = model[0]
...
def vgg_igsm_detection(image, model):
    # print("local......................")
    # print(image)
    img = Image.open(image)
    detection_model = model[0]
...
def vgg_mifgsm_detection(image, model):
    # print("local......................")
    # print(image)
    img = Image.open(image)
    detection_model = model[0]
...
def vgg_pgd_detection(image, model):
    # print("local......................")
    # print(image)
    img = Image.open(image)
    detection_model = model[0]
...
def vgg_finefool_detection(image, model):
    # print("local......................")
    # print(image)
    img = Image.open(image)
    detection_model = model[0]
...
def vgg_jsma_detection(image, model):
    # print("local......................")
    # print(image)
    img = Image.open(image)
    detection_model = model[0]
...
def vgg_onepixel_detection(image, model):
    # print("local......................")
    # print(image)
    img = Image.open(image)
    detection_model = model[0]
...
def vgg_uap_detection(image, model):
    # print("local......................")
    # print(image)
    img = Image.open(image)
    detection_model = model[0]
...
def vgg_zoo_detection(image, model):
    # print("local......................")
    # print(image)
    img = Image.open(image)
    detection_model = model[0]
...
def vgg_boundary_detection(image, model):
    # print("local......................")
    # print(image)
    img = Image.open(image)
    detection_model = model[0]
...
if __name__ == "__main__":
    FGSM_IMAGES_PATH = "/data/Newdisk/chenjingwen/DT_B4/SJS_detect/Image/datasets/gen_data/Military/VGG16/select_data/FGSM-Lambda1/png"  # 测试数据集路径

    VGG16_MODEL_PATH = '/data/Newdisk/chenjingwen/DT_B4/SJS_detect/Image/model_data/VGG16_Military.pth'
    FGSM_MODEL_PATH = "/data/Newdisk/chenjingwen/DT_B4/SJS_detect/Image/model_data/detect/SentimentDetect_Military_VGG16_All-Attack.pth"  # 测试检测模型路径
