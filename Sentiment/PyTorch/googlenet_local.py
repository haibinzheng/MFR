...
if __name__ == "__main__":
    FGSM_IMAGES_PATH = "/data/Newdisk/chenjingwen/DT_B4/SJS_detect/Image/datasets/gen_data/Military/GoogleNet/select_data/FGSM-Lambda1/png"  # 测试数据集路径

    GOOGLENET_MODEL_PATH = '/data/Newdisk/chenjingwen/DT_B4/SJS_detect/Image/model_data/GoogleNet_Military.pth'
    FGSM_MODEL_PATH = "/data/Newdisk/chenjingwen/DT_B4/SJS_detect/Image/model_data/detect/SentimentDetect_Military_GoogleNet_All-Attack.pth"  # 测试检测模型路径

    model = []
    FGSM_MODEL = model_load(FGSM_MODEL_PATH, "detect")
    GOOGLENET_MODEL = model_load(GOOGLENET_MODEL_PATH, "classify")
    model.append(FGSM_MODEL)
    model.append(GOOGLENET_MODEL)
