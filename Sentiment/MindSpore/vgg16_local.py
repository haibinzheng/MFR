...
if __name__ == "__main__":
    FGSM_IMAGES_PATH = "/data/Newdisk/chenjingwen/DT_B4/SJS_detect/Image_mindspore/dataset/PatchAttack"  # 测试数据集路径
    ...
    for file_path, root in all_files:
        ...
        with open(file_path, "rb") as img_file:
            ...
            # if ori_saved < 50 and 'ori' in file_path.split('/') and result == 0 and class_pred == class_name:
            #     os.makedirs(
            #         '/data/Newdisk/chenjingwen/DT_B4/SJS_detect/Image_mindspore/dataset/PatchAttack/ori/{}'.format(
            ...
            # if adv_saved < 50 and 'adv' in file_path.split('/') and result == 1 and class_pred != class_name:
            #     os.makedirs(
            #         '/data/Newdisk/chenjingwen/DT_B4/SJS_detect/Image_mindspore/dataset/PatchAttack/adv/{}'.format(
            #             class_name), exist_ok=True)
            #     adv_saved += 1
            #     shutil.copy(file_path, os.path.join(
            #         '/data/Newdisk/chenjingwen/DT_B4/SJS_detect/Image_mindspore/dataset/PatchAttack/adv/{}'.format(
            #             class_name),
            #         os.path.basename(file_path)))
            # if adv_saved >= 50 and ori_saved >= 50:
            #     break
